...
namespace Abstraction.Models
{
    public class Prices
    {
        ...
        [Required]
        public List<FuelPriceHistory> E10 { get; set; }

        [Required]
        public List<FuelPriceHistory> E85 { get; set; }

        [Required]
        public List<FuelPriceHistory> Gazole { get; set; }

        [Required]
        public List<FuelPriceHistory> GpLc { get; set; }

        [Required]
        public List<FuelPriceHistory> Sp95 { get; set; }

        [Required]
        public List<FuelPriceHistory> Sp98 { get; set; }
