				...
				<Grid container spacing={2} direction={"column"}>
					<Grid item>
						...
						<Typography variant={"body1"}>
							Jonathan Guichard built the ElyTransport app as a Free app. This SERVICE is provided by Jonathan Guichard at no cost and is intended for use as is.
						</Typography>
						...
						<Typography>
							The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at ElyTransport unless otherwise
					...
					<Grid item>
						...
						<Typography>
							For a better experience, while using our Service, I require you to provide us your <strong>Precise Location</strong>.
						</Typography>
						<Typography>The app does use third-party services that may collect information used to identify you.</Typography>
						<Typography>
							Link to the privacy policy of third-party service providers used by the app
							<Link ml={1} href="https://www.google.com/policies/privacy/">
								Google Slay Services
							</Link>
							.
						</Typography>
					</Grid>
					...
					<Grid item>
						...
						<Typography>I may employ third-party companies and individuals due to the following reasons:</Typography>
						<List>
							<ListItem>
							...
							<ListItem>
								<Typography variant={"body2"}>To assist us in analyzing how our Service is used</Typography>
							</ListItem>
						</List>
						<Typography>
							I want to inform users of this Service that these third parties have access to their Personal Information. The reason is to perform the tasks assigned
					...
					<Grid item>
						...
						<Typography>
							...
							not operated by me. Therefore, I strongly advise you to review the Privacy Policy of these websites. I have no control over and assume no responsibility
					...
					<Grid item>
						...
						<Typography>
							...
							age. In the case I discover that a child under 13 has provided me with personal information, I immediately delete this from our servers. If you are a
							parent or guardian and you are aware that your child has provided us with personal information, please contact me so that I will be able to do the
							necessary actions.
						</Typography>
					</Grid>
					...
					<Grid item>
						...
						<Typography>
							...
							<Link href={"mailto:elyspio.dev@gmail.com"}>elyspio.dev@gmail.com</Link>.
						</Typography>
						<Typography>
							This privacy policy page was created at
							<Link mx={1} href={"https://privacypolicytemplate.net"}>
								https://privacypolicytemplate.net
							</Link>
							and modified/generated by{" "}
							<Link ml={1} href={"https://app-privacy-policy-generator.nisrulz.com"}>
